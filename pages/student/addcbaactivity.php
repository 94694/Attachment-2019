...
if(isset($_POST['addcbadailybtn']))
{
    $cbaDailyDate=$_POST['cbaDailyDate'];
    $Cbaobjectives=$_POST['Cbaobjectives'];
    $CbaActivities=$_POST['CbaActivities'];
    $Lessonlearnt=$_POST['Lessonlearnt'];
    ...
    $insertQuery="INSERT INTO cbadailyactivities(cbaDailyDate,cbaObjectives, CbaActivities,Lessonlearnt,totalhours,cbaStudentId) VALUES('$cbaDate','$cbaObjectives',$cbaDescription','$Lessonslearnt','$totalhours','$studentId')";

    $results=mysqli_query($con, $insertQuery);

    if($results===TRUE)
    {
        $_SESSION['cbas']='Activity inserted ';
        $_SESSION['cbaf']='';
    }else{
        $_SESSION['cbas']='';
        $_SESSION['cbaf']='Insert failed '.$studentId;
    }
}
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">New CBA Activity</li>
      </ol>
    </div>

      <?php $success = $_SESSION['cbas'];
      $fail = $_SESSION['cbaf'];
    ...
    <form role="form" id="student_registration" method="post" action="">
            <div class="col-md-12" >
                 <div class="form-group col-md-6 col-lg-6" >
                    <label class="control-label">CBA Date*</label>
                    <input type="text" name="cbaDate" class="form-control" required="required" id="cbaDate">
                </div>
                <div class="col-md-12" >
                 <div class="form-group col-md-6 col-lg-6" >
                    <label class="control-label">CBA Objectives*</label>
                    <input type="text" name="Objectives" class="form-control" required="required" id="Objectives">
                </div>
                <div class="form-group col-md-12 col-lg-12" >
                    <label  class="control-label">CBA Activities*</label>
                    <textarea style="height: 200px;" type="text" name="cbaDescription" class="form-control"  required="required"></textarea>
                </div>
                <div class="col-md-12" >
                 <div class="form-group col-md-6 col-lg-6" >
                    <label class="control-label">Lessonslearnt*</label>
                    <input type="text" name="cbaDate" class="form-control" required="required" id="Lessonslearnt">
                </div>
                <div class="col-md-12" >
                 <div class="form-group col-md-6 col-lg-6" >
                    <label class="control-label">TOTALHOURS*</label>
                    <input type="text" name="TOTALHOURS" class="form-control" required="required" id="cbaDate">
                </div>
                <div class="form-group col-md-12 col-lg-12">
                <div class="modal-header"></div>
                    <br>
                    <input type="submit" class="btn btn-primary" value="Submit" name="addcbadailybtn">
