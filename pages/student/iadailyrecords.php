...
//query to select all ia daily activities from database
$iaDailyQuery="SELECT * FROM iadailyactivities WHERE iaStudentId='$userSUID'";

//query the db with mysqli
$activities=mysqli_query($con,$iaDailyQuery);
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">IA Activity Records</li>
      </ol>
       <div class="row">
                <div class="col-md-12">
                   <a class="btn btn-primary btn-s" href="http://localhost/attachment/pages/student/addiaactivity.php"><span class="fa fa-plus-circle"></span>&nbsp;Add Record</a>
                    <br><br>
                            ...
                            if($activities)
                                {  
                                  ...
                                  while($row=mysqli_fetch_assoc($activities))
                                        { ?>
                                <tr>
                                    <td class="text-left"><?php echo $row['iaDailyDate'];?></td>
                                    <td class="text_center"><?php echo $row['objecives'];?></td>
                                    <td class="text-center"><?php echo $row['iaActivities'];?></td>
                                    <td class="text-center"><?php echo $row['Lessonslearnt'];?></td>
                                    <td class="text-center"><?php echo $row['Totalhours'];?></td>
                                      
                                     <form style="display:inline;" name="edit_<?php echo $row['studentAutoId']; ?>" method="post" action="http://localhost/attachment/pages/student/editiadaily.php">
