...
if(isset($_POST['editstudent']))//if submit button called edit is clicked, 
{
...
if(isset($_POST['updatestudentbtn']))
{
    ...
    $updateQ="UPDATE students SET studentFname='$fname',studentLname='$lname',studentSUID='$suid',studentGender=' $gender',studentPhone='$pno', studentEmail='$email',studentCourseId=' $courseid' WHERE studentAutoId='$studentPID' ";
    ...
    if($affectedRows>0)
        {
            $_SESSION['sus']='Update success';
            $_SESSION['suf']='';
        }else{
            $_SESSION['sus']='';
            $_SESSION['suf']='No changes';
        }
}
            ...
            <div class="col-md-12" >
                ...
                <?php $gen= $row['studentGender'] ;if($gen=="Female"){
                  ...
                  <div class="form-group col-md-6 col-lg-6">
                      ...
                      <input type="text" name="suid" class=" form-control" id="suid" required="required" value="<?php echo $row['studentSUID'] ; ?>">
                  </div>
                ...
                <div class="form-group col-md-6 col-lg-6">
                    ...
                    <select type="text" name="courseId" placeholder="" class=" form-control"  required="required">
                        ...
                        <option value="<?php echo $row['studentCourseId'] ; ?>"><?php echo $row['courseCode'] ; ?>"
                ...
                <div class="modal-header"></div>
                    <br>
                    <input type="submit" class="btn btn-primary" value="Submit" name="updatestudentbtn">
