...
//query to select all supervisors from database
...
$supervisor=mysqli_query($con,$supervisorQuery);
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
       ...
       <div class="row">
                <div class="col-md-12">
                    <table  class="table table-bordered" id="supervisors">
                        <thead>
                            <tr>
                          ...
                          //check if results is empty.
                            if($supervisor)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $row['supervisorSUID'];?></td>
                                    <td class="text-center"><?php echo $row['supervisorPhone'];?></td>
                                    <td class="text-center"><?php echo $row['facultyCode'];?></td>
                                    <td class="text-center">
                                      <form style="display:inline;" name="edit_<?php echo $row['supervisorAutoId']; ?>" method="post" action="http://localhost/attachment/pages/admin/editsupervisor.php">
                                        
                                        <input required="required" class="form-control" name="supsuid"  value="<?php echo $row['supervisorAutoId']; ?>" style="display: none;">
                                        <button class="btn btn-primary btn-s" type="submit" name="editsupervisor" > <span class="fa fa-edit"></span> Edit </button>
                                    </form>
...
$(document).ready(function () {
    //datatable initialization
     var table=$('#supervisors').DataTable({responsive:true,"iDisplayLength": 10,"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],columnDefs: [ { orderable: false, targets: [4] }]
   });
});
</script>
</body>
