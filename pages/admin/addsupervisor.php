...
if(isset($_POST['addsupervisorbtn']))
{
    ...
    $facultId=$_POST['facultyId'];
    $password=md5($suid);//encrypted with md5 encryption algorithm. Default pass is SUID
    
    $insertQuery="INSERT INTO supervisor(supervisorFname, supervisorLname, supervisorPhone, supervisorGender, supervisorEmail,supervisorFacultyId,supervisorSUID,supervisorPassword ) VALUES('$fname','$lname','$pno','$gender','$email','$facultId','$suid','$password')";

    $results=mysqli_query($con, $insertQuery);

    if($results===TRUE)
    {
        $_SESSION['srs']='Supervisor inserted ';
        $_SESSION['srf']='';
    }else{
        $_SESSION['srs']='';
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">New Supervisor</li>
      </ol>
    </div>
    ...
    <form role="form" id="supervision_registration" method="post" action="">
            <div class="col-md-12" >
                ...
                <div class="form-group col-md-6 col-lg-6">
                  ...
                  <div class="form-group col-md-6 col-lg-6">
                      <label for="suid" class="control-label">Staff No.*</label>
                ...
                <div class="modal-header"></div>
                    <br>
                    <input type="submit" class="btn btn-primary" value="Submit" name="addsupervisorbtn">
