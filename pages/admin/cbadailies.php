...
{
    $cbaDate=$_POST['cbaDate'];
    $cbaDescription=$_POST['cbaDescription'];
    $studentId=$_SESSION['username'];
   



    $insertQuery="INSERT INTO cbadailies(cbaDailyDate, cbaDailyActivities,cbaStudentId) VALUES('$cbaDate','$cbaDescription','$studentId')";
